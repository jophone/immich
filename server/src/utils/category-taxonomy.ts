...
const L1_RENAME_MAP: Record<string, CategoryLevel> = {
  ...
  人像照: { id: 'portrait', nameZh: '人像照', nameEn: 'Portrait' },
  宠物照: { id: 'pet_photos', nameZh: '宠物照', nameEn: 'Pet Photos' },
  人与宠物: { id: 'people_with_pets', nameZh: '人与宠物', nameEn: 'People with Pets' },
...
const L2_RENAME_MAP: Record<string, CategoryLevel> = {
  ...
  '人像照|单人': { id: 'portrait_single_person', nameZh: '单人', nameEn: 'Single Person' },
  '人像照|双人': { id: 'portrait_two_people', nameZh: '双人', nameEn: 'Two People' },
  '人像照|多人': { id: 'portrait_multiple_people', nameZh: '多人', nameEn: 'Multiple People' },
  '人像照|合影': { id: 'portrait_group_portrait', nameZh: '合影', nameEn: 'Group Portrait' },
  '人像照|自拍': { id: 'portrait_selfie', nameZh: '自拍', nameEn: 'Selfie' },
  '人像照|半身像': { id: 'portrait_half_body', nameZh: '半身像', nameEn: 'Half Body Portrait' },
  '人像照|全身像': { id: 'portrait_full_body', nameZh: '全身像', nameEn: 'Full Body Portrait' },
  '人像照|证件照': { id: 'portrait_id_photo', nameZh: '证件照', nameEn: 'ID Photo' },
  '人像照|人像特写': { id: 'portrait_close_up', nameZh: '人像特写', nameEn: 'Close-up Portrait' },
  '人像照|生活照': { id: 'portrait_lifestyle', nameZh: '生活照', nameEn: 'Lifestyle Portrait' },
  '人像照|亲子照': { id: 'portrait_parent_child', nameZh: '亲子照', nameEn: 'Parent-Child Photo' },
  '人像照|情侣照': { id: 'portrait_couple', nameZh: '情侣照', nameEn: 'Couple Photo' },
  '人像照|家庭合照': { id: 'portrait_family_group', nameZh: '家庭合照', nameEn: 'Family Group Photo' },
  '人像照|朋友合照': { id: 'portrait_friends_group', nameZh: '朋友合照', nameEn: 'Friends Group Photo' },
  '人像照|团队合照': { id: 'portrait_team_group', nameZh: '团队合照', nameEn: 'Team Group Photo' },

  '宠物照|宠物狗': { id: 'pet_photos_dog', nameZh: '宠物狗', nameEn: 'Pet Dog' },
  '宠物照|宠物猫': { id: 'pet_photos_cat', nameZh: '宠物猫', nameEn: 'Pet Cat' },
  '宠物照|宠物鸟': { id: 'pet_photos_bird', nameZh: '宠物鸟', nameEn: 'Pet Bird' },
  '宠物照|宠物兔': { id: 'pet_photos_rabbit', nameZh: '宠物兔', nameEn: 'Pet Rabbit' },
  '宠物照|宠物仓鼠': { id: 'pet_photos_hamster', nameZh: '宠物仓鼠', nameEn: 'Pet Hamster' },
  '宠物照|宠物龟': { id: 'pet_photos_turtle', nameZh: '宠物龟', nameEn: 'Pet Turtle' },
  '宠物照|宠物鱼': { id: 'pet_photos_fish', nameZh: '宠物鱼', nameEn: 'Pet Fish' },
  '宠物照|其他宠物': { id: 'pet_photos_other', nameZh: '其他宠物', nameEn: 'Other Pets' },

  '人与宠物|人与狗': { id: 'people_with_pets_dog', nameZh: '人与狗', nameEn: 'People with Dog' },
  '人与宠物|人与猫': { id: 'people_with_pets_cat', nameZh: '人与猫', nameEn: 'People with Cat' },
  '人与宠物|人与宠物': { id: 'people_with_pets_pet', nameZh: '人与宠物', nameEn: 'People with Pet' },
