...
| `MACHINE_LEARNING_DEFAULT__CLIP__TEXTUAL`                   | Default textual CLIP model to use when a request omits `modelName`                                                                                           | first preload, else built-in    | machine learning |
| `MACHINE_LEARNING_DEFAULT__CLIP__VISUAL`                    | Default visual CLIP model to use when a request omits `modelName`                                                                                            | first preload, else built-in    | machine learning |
| `MACHINE_LEARNING_DEFAULT__FACIAL_RECOGNITION__RECOGNITION` | Default facial recognition model to use when a request omits `modelName`                                                                                     | first preload, else built-in    | machine learning |
| `MACHINE_LEARNING_DEFAULT__FACIAL_RECOGNITION__DETECTION`   | Default facial detection model to use when a request omits `modelName`                                                                                       | first preload, else built-in    | machine learning |
| `MACHINE_LEARNING_DEFAULT__OCR__RECOGNITION`                | Default OCR recognition model to use when a request omits `modelName`                                                                                        | first preload, else built-in    | machine learning |
| `MACHINE_LEARNING_DEFAULT__OCR__DETECTION`                  | Default OCR detection model to use when a request omits `modelName`                                                                                          | first preload, else built-in    | machine learning |
| `MACHINE_LEARNING_DEFAULT__CLASSIFICATION`                  | Default classification model to use when a request omits `model_name`                                                                                        |          `YOLO26l-cls`          | machine learning |
| `MACHINE_LEARNING_DEFAULT__DETECTION`                       | Default object detection model to use when a request omits `model_name`                                                                                      |            `yolov8l`            | machine learning |
